...
#include "../../server_socket/GUI_Client/socketClient.h"
...
QT_MOC_LITERAL(3, 22, 14), // "onReceivedData"
QT_MOC_LITERAL(4, 37, 4) // "text"

    },
    "SocketClient\0changed\0\0onReceivedData\0"
    "text"
};
...
void SocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onReceivedData(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketClient::changed)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->send(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
